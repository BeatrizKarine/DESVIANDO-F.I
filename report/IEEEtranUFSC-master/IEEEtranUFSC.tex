...
\expandafter\newcommand\csname prenome2\endcsname     {Beatriz}
\expandafter\newcommand\csname nomedomeio2\endcsname  {Karine}
\expandafter\newcommand\csname sobrenome2\endcsname   {Cardoso}

%% Terceiro autor (a acenturação deverá ser indireta)
\expandafter\newcommand\csname prenome3\endcsname     {Higor}
\expandafter\newcommand\csname nomedomeio3\endcsname  {Firme da Rocha}
\expandafter\newcommand\csname sobrenome3\endcsname   {dos Santos}
